<template>
	<div id="Home">
		...
		<main class="layout_page" ref='page'>
			<section class="bgcolor">
				...
				<div class="aside aside_center">
					<Breadcrumb v-show="$route.params.name"/>
...
<script>
	...
	const BodyWrap = ()=> import('@/components/BodyWrap') //第一页背景
	...
	export default {
		name:'Home',
		components:{
			BodyWrap,Header,UserCard,Tags,Breadcrumb,Notice,Masking,Classify,Label,GoUp,Mobile,Footer
		},
		props:{
			winWidth:{
				type:Number,
		...
		methods:{
			...
			//返回顶部
			backTop(){
				jump(this.$refs.page,{duration:500})
			},
		}
	}
</script>
...
<style scoped>
	...
	@media screen and (max-width: 768px) {
		.aside_left,.aside_right,.aside_center{
			width: 100%;
			margin-bottom: 0;
		}
		.aside_center{
